Feature: search for donations by director

  As a movie buff
  So that I can find donations with my favorite director
  I want to include and serach on director information in donations I enter
  ...
  Background: donations in database
    ...
    Given the following donations exist:
      ...
      | Mincan He   | hemincan@outlook.com | wolf       | Dallas  | Texas | 78000 | 2016-06-06    | Fruit     | Banana      | 10          | None       | 0
      | Haoran Wang | haoranwang@tamu.edu  | wolf       | Austin  | Texas | 79000 | 2015-10-25    | Meat      | Pork        | 5           | Check      | 500

  Scenario: visit home page of Brazos Valley Food Bank
  ...
  Scenario: visit a donation's detail page
  ...
  Scenario: add a new donation
    ...
    And  I fill in "Name of organization / individual" with "Jiangtian Qian"
    ...
    And  I select date "2007/12/11" in "Donation date"
    And  I press "Submit"
